...
def pull_data(dataset_name, output_directory):
    ...
    return kagglehub.dataset_download(dataset_name, output_dir=str(output_directory), force_download=True,)
...
def main():
    ...
    """
    weather_data_path = pull_data("ananthr1/weather-prediction", Path(__file__).resolve().parent.parent / "data" / "weather-prediction")
